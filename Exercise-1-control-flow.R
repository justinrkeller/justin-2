...
#####################################
#Plotting assignment begins below 
...
barplot(rbind(counts_100,counts_1000), col=c(2,4), beside=T,names.arg=seq(65,72,by=1), xlab="Average height(in)", ylab="Count")
legend('topright',c('n=100','n=100'), col=c(2,4),lwd=4)
